...
public class ComapareWithStem {
    ...
    public   void theOr(Map<String, LinkedList<Integer>> index) {
        ...
        word51 = porterStemmer.stemWord(word51);
        printer.print("   word2: ");
        String word52 = new Scanner(System.in).nextLine();
        word52 = porterStemmer.stemWord(word52);
    ...
    public   void and(Map<String, LinkedList<Integer>> index) {
        ...
        word41 = porterStemmer.stemWord(word41);
        printer.print("   word2: ");
        String word42 = new Scanner(System.in).nextLine();
        word42 = porterStemmer.stemWord(word42);
    ...
    public   void orNot(Map<String, LinkedList<Integer>> index) {
        ...
        word31 = porterStemmer.stemWord(word31);
        printer.print("   word2: ");
        String word32 = new Scanner(System.in).nextLine();
        word32 = porterStemmer.stemWord(word32);
        printer.print("   word3: ");
        String word33 = new Scanner(System.in).nextLine();
        word33 = porterStemmer.stemWord(word33);
    ...
    public   void andOr(Map<String, LinkedList<Integer>> index) {
        ...
        word21 = porterStemmer.stemWord(word21);
        printer.print("   word2: ");
        String word22 = new Scanner(System.in).nextLine();
        word22 = porterStemmer.stemWord(word22);
        printer.print("   word3: ");
        String word23 = new Scanner(System.in).nextLine();
        word23 = porterStemmer.stemWord(word23);
    ...
    public   void andNot(Map<String, LinkedList<Integer>> index) {
        ...
        word3 = porterStemmer.stemWord(word3);
